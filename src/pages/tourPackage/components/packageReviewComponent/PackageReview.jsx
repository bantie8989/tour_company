...
const PackageReviews = ({ reviews }) => {
    reviews = [
            {
              ...
              description: 'This tour package was amazing! The guide was knowledgeable and friendly, and the sights were breathtaking.',
              date: '2023-02-15',
              rating: 5,
            },
            {
              ...
              description: 'The tour package was good, but there were a few areas that could be improved. The guide was knowledgeable but could have been more engaging.',
              date: '2023-02-14',
              rating: 3,
            },
            {
              ...
              description: 'This tour package was incredible! The sights were amazing, and the guide was friendly and knowledgeable. I would highly recommend it!',
              date: '2023-02-13',
              rating: 5,
            },
          ];
  ...
  const filteredReviews = sortedReviews.filter((review) => review.rating >= filterBy);
  ...
  return (
    <div className="package-reviews">
      ...
      <div className="package-reviews__sort-filter">
        ...
        <label htmlFor="filter-by">Filter by rating:</label>
        ...
        {filteredReviews.map((review) => (
          <li key={review.id} className="package-reviews__item">
            ...
            <div className="package-reviews__content">
              ...
              <p className="package-reviews__description">{review.description}</p>
